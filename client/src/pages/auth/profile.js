...
const Profile = () => {
    return (
        <div className="my-12 sm:w-full">
            <form className="bg-white rounded-lg m-14">
                ...
                <div className="mt-6 flex items-center justify-end gap-x-6">
                    ...
                    <button type="submit" className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:dark:bg-gray-800 bg-gray-50 dark:bg-gray-700 dark:text-gray-100">Save</button>
                </div>
            </form>
        </div>
    );
